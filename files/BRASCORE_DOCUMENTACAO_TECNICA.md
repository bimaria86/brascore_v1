...
**Data:** Maio 2026
**Versão:** 1.0
**Status:** Em Transição de Base de Dados
...
- ✅ Coleta padronizada de dados de 36 centros (2.267 pacientes)
...
## ⏱️ Cronograma {#cronograma}

### Fase 1: Transição (Próximas 4-6 semanas)

| Semana | Tarefa |
|--------|--------|
| **1-2** | ✅ Auditoria de dados (em andamento) |
| **2-3** | Refatoração banco (SQL, migrations) |
| **3-4** | Sistema de upload + validação |
| **4-5** | Treinamento dos 36 centros |
| **5-6** | Re-upload de dados + limpeza |

### Fase 2: Congresso (Mês 2)

- ✅ Dashboards de visualização (com dados atuais)
- ✅ Relatórios sumarizados
- ✅ Apresentação de resultados preliminares
- ✅ Proposta de patrocínio

### Fase 3: Produção (Meses 3-4)

- API REST completa
- Dashboards finais interativos
- Integração de escore Python
...
1. **Revisar e aprovar** arquitetura com time
2. **Confirmar cronograma** com patrocinadores
3. **Iniciar migração** do banco de dados
4. **Desenvolvedor:** Montar sistema de upload
5. **Comitê BraSCORE:** Validar codebook
...
| Papel | Contato |
|------|---------|
| **Coordenador Geral** | (seu email) |
| **Tech Lead** | (dev email) |
| **Comitê BraSCORE** | (cirurgiões) |
| **Suporte Técnico** | (helpdesk) |

---

**Versão 1.0 | Maio/2026 | Pronto para congresso**
